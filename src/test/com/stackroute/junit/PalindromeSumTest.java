...
public class PalindromeSumTest {
    PalindromeSum palindromesum;
    String actualresult;
    String expectedresult;
    @Before
    public void setUp()throws Exception {
        palindromesum = new PalindromeSum();
    }

    @Test
    public void checkIfPalindromeandSumGreaterThan25()
    {
        actualresult=palindromesum.sum25(896787698);
    ...
    {
        actualresult= palindromesum.sum25(1234321);
    ...
    {
        actualresult = palindromesum.sum25( 123456);
